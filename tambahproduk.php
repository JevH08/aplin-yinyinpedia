    ...
    if (isset($_POST["nambah"])) {
        if ($_POST["name"] != "" && $_POST["kategori"] != "" && $_POST["price"] != "" && $_POST["deskripsi"] != "" && $_POST["stock"] != "" && (int)$_POST["stock"] > 0 && $_POST["tag"] != "" && (int) $_POST["weight"] > 0 && $_POST['kondisi'] != '') {
            ...
            if ($_FILES['imgupload']['tmp_name'] != null){
                ...
                $profile = addslashes(file_get_contents("C:/xampp/htdocs/AplinProject2/gambar/default.png"));
            }
            if ($kategori == "barang") $idkategori = 1;
            else $idkategori = 2;
            insert_produk_detail($idpenjual,$idkategori,$nama,$desc,$stok,$harga,$profile,$berat,$kondisi,$tag);
        }
        else{
	        ...
	        <ul class="nav navbar-nav">
	          ...
	          <li class="dropdown dropdown-slide">
	            ...
	            <ul class="dropdown-menu">
					<li><?php echo '<img id=proPic src="data:image;base64,' .  base64_encode($profile2)  . '" class="img-responsiveHOME"/>'; ?></li><br>
...
<div class="page-wrapper">
    <div class="container text-center col-md-6" id="padLeft">
        ...
        <form method="post" enctype="multipart/form-data" class="text-center" style="color: #757575;">
            <div>
                Product Name <input type="text" id="materialAddProductFormProductName" class="form-control" name=name placeholder="Product Name">
            </div> <br>
            <div>
            Category
                <select class="browser-default form-control custom-select" name="kategori">
                    ...
                    <option value="hewan">Animals</option>
                </select>
            </div>
            <h6>Product Image</h6>
            <div class="md-form mt-0">
                <div class="col">
                    <img src="<?php echo"$defaultLink"?>" alt="Profile Picture" id="prodPic"><br>
            ...
            <h6>Product Price</h6>
            <div>
                Rp <input type="text" id="materialAddProductFormProductPrice" class="form-control" name=price placeholder="0">
            </div> <br>
            <h6>Product Description</h6>
            <div>
                Product Detail <br>
                <textarea id="materialAddProductFormDescriptionOrder" name="deskripsi" class="form-control"> </textarea> <br>
            </div> <br>
            <h6>Product Status</h6>
            <div>
                Amount of Stock <input type="text" id="materialAddProductFormAmmountStock" class="form-control" name=stock placeholder="1">
                <h7>Info Advanced</h7>
                Tag <input type="text" id="materialAddProductFormTag" class="form-control" name=tag>
            ...
            <div>
                ...
                kg <input type="text" id="materialAddProductFormProductWeight" class="form-control" name=weight placeholder="0">
            ...
            <button type="submit" name="nambah"> Add Product </button>
        </form>
    </div>
</div>
